...
const translations = {
  id: {
    ...
    aiAutomationBasedOnFaceRecognition: "Otomatisasi berdasarkan pengenalan wajah",
    smartClusteringStatus: "Status Smart Clustering",
    advancedCameraMonitoringSystem: "Sistem Monitoring Kamera Canggih",
    advancedSuspiciousActivityDetection: "Deteksi Aktivitas Mencurigakan Canggih",
    faceRecognitionAccessControl: "Pengenalan Wajah & Kontrol Akses",
    aiPoweredRealTimeThreatAnalysis: "Analisis ancaman real-time bertenaga AI dan pemantauan perilaku",
    aiPoweredFacialRecognition: "Sistem manajemen pengenalan wajah dan akses bertenaga AI",
    investigating: "Menyelidiki",
    falsePositive: "Positif Palsu",
    emergencyResponseProtocol: "Protokol Respons Darurat",
    aiSettings: "Pengaturan AI",
    totalFacesRegistered: "Total Wajah Terdaftar",
    currentVisitors: "Pengunjung Saat Ini",
    unknownFaces: "Wajah Tidak Dikenal",
    recentRecognitionEvents: "Peristiwa Pengenalan Terbaru",
    manageFaceRecognitionDatabase: "Kelola Database Pengenalan Wajah",
    systemComponents: "Komponen Sistem",
    securityScan: "Pemindaian Keamanan",
    detailedReport: "Laporan Terperinci",
    cameraNetwork: "Jaringan Kamera",
    faceRecognitionAI: "AI Pengenalan Wajah",
    motionDetectionSystem: "Sistem Deteksi Gerakan",
    accessControlSystem: "Sistem Kontrol Akses",
    alarmSystem: "Sistem Alarm",
    emergencyProtocol: "Protokol Darurat",
    networkSecurity: "Keamanan Jaringan",
    dataBackup: "Backup Data",
    cameraTechnicalSpecifications: "Spesifikasi Teknis Kamera",
    resolutionFPS: "Resolusi & FPS",
    zoomCapability: "Kemampuan Zoom",
    storageType: "Jenis Penyimpanan",
    lastMaintenance: "Pemeliharaan Terakhir",
    nightVision: "Night Vision",
  audioRecording: "Perekaman Audio",
  // Navbar/Profile
  signOut: "Keluar",
  markAllAsRead: "Tandai semua sudah dibaca",
  // Navbar search/notifications
  searchPlaceholder: "Cari fitur, halaman, atau aksi...",
  ...
  transactionHistoryDesc: "Riwayat transaksi dan pembayaran terbaru",
  allTypes: "Semua Jenis",
  monthlyFee: "Iuran Bulanan",
  securityDeposit: "Uang Jaminan",
  maintenanceFee: "Biaya Perawatan",
  paymentIntegration: "Integrasi Pembayaran",
  paymentIntegrationDesc: "Status integrasi sistem pembayaran online",
  qrisPayment: "Pembayaran QRIS",
  onlineGateway: "Gateway Online",
  lastSync: "Sinkron terakhir",
  quickResponseIndonesiaStandard: "Quick Response Indonesia Standard",
  automaticBankIntegration: "Integrasi bank otomatis",
  popularEwallets: "GoPay, OVO, DANA, ShopeePay",
  midtransXenditPaypal: "Midtrans, Xendit, PayPal",
  paymentMethodLabel: "Metode Pembayaran",
  autoUpdateFeature: "Fitur Pembaruan Otomatis",
  autoUpdateDesc: "Sistem akan otomatis memperbarui status pembayaran ketika transaksi berhasil melalui payment gateway yang terintegrasi.",

  // Finance (form)
  addManualTransaction: "Tambah Transaksi Manual",
  manualPaymentInputDesc: "Input pembayaran manual (transfer tunai, offline)",
  blockUnit: "Blok/Unit",
  nominal: "Nominal",
  paymentType: "Jenis Pembayaran",
  other: "Lainnya",
  notesOptional: "Catatan (Opsional)",
  addNotePlaceholder: "Tambahkan catatan jika diperlukan...",
  saveTransaction: "Simpan Transaksi",
  resetForm: "Reset Form",
  blockUnitPlaceholder: "Contoh: A-12",

  // OSP/Security shared extra
  camerasOnline: "Kamera Online",
  totalRecordingHours: "Total Rekaman",
  motionDetection: "Deteksi Gerak",

  // Charts
  securityAnalytics24hOverview: "Analitik Keamanan - Ringkasan 24 Jam",
  realtimeDetectionTrends: "Tren deteksi dan verifikasi real-time",
  totalDetections: "Total Deteksi",
  threatLevelDistribution: "Distribusi Tingkat Ancaman",
  currentThreatClassification: "Klasifikasi ancaman saat ini",
  totalLabel: "Total",

  // Settings extra
  lightModeDesc: "Antarmuka cerah dan bersih",
  darkModeDesc: "Nyaman di mata",
  emailNotifications: "Notifikasi Email",
  smsNotifications: "Notifikasi SMS",
  pushNotifications: "Notifikasi Push",
  defaultPageAfterLogin: "Halaman Default Setelah Masuk",
  manualBackup: "Backup Manual",
  viewAndEditProfile: "Lihat dan edit profil",
  lastBackup: "Backup Terakhir",
  systemMaintenanceDesc: "Optimalkan database dan bersihkan cache",
  twoFactorAuth: "Autentikasi Dua Faktor (2FA)",
  twoFactorDescription: "Tambahkan lapisan keamanan ekstra ke akun Anda",
  twoFactorEnabledNotice: "2FA aktif dan melindungi akun Anda",
  cancelPasswordChange: "Batalkan Ubah Kata Sandi",
  ...
  performanceOverview: "Ikhtisar performa Anda",
  tasksCompletedLabel: "Tugas Selesai",
  tasksPending: "Tugas Menunggu",
  reportsSubmitted: "Laporan Dikirim",
  monthlyProgressLabel: "Kemajuan Bulanan",
  ofMonthlyTargetCompleted: "dari target bulanan tercapai",
  accountSecurity: "Keamanan Akun",
  protectYourAccount: "Lindungi akun Anda",
  devicesConnected: "Perangkat terhubung",
  currentSession: "Sesi Saat Ini",
  currentSessionShort: "Saat Ini",
  lastActiveLabel: "Terakhir aktif",
  securityScoreLabel: "Skor Keamanan",
  excellentSecurityLevel: "Level keamanan sangat baik",
  tasks: "tugas",
  aiAnalysisLabel: "Analisis AI",
  confidence: "Kepercayaan",
  alertSecurity: "Beri Tahu Keamanan",
  lockDownArea: "Kunci Area",
  recordEvidence: "Rekam Bukti",
  monitorClosely: "Awasi dengan Ketat",
  sendWarning: "Kirim Peringatan",
  reviewFootage: "Tinjau Rekaman",
  alertPersonnel: "Beri Tahu Petugas",
  immediateInvestigation: "Investigasi Segera",
  securityResponse: "Respon Keamanan",
  },
  en: {
    // Sidebar
    dashboard: "Dashboard",
    ...
    aiAutomationBasedOnFaceRecognition: "AI automation based on face recognition",
    smartClusteringStatus: "Smart Clustering Status",
    advancedCameraMonitoringSystem: "Advanced Camera Monitoring System",
    advancedSuspiciousActivityDetection: "Advanced Suspicious Activity Detection",
    faceRecognitionAccessControl: "Face Recognition & Access Control",
    aiPoweredRealTimeThreatAnalysis: "AI-powered real-time threat analysis and behavior monitoring",
    aiPoweredFacialRecognition: "AI-powered facial recognition and access management system",
    investigating: "Investigating",
    falsePositive: "False Positive",
    emergencyResponseProtocol: "Emergency Response Protocol",
    aiSettings: "AI Settings",
    totalFacesRegistered: "Total Faces Registered",
    currentVisitors: "Current Visitors",
    unknownFaces: "Unknown Faces",
    recentRecognitionEvents: "Recent Recognition Events",
    manageFaceRecognitionDatabase: "Manage Face Recognition Database",
    systemComponents: "System Components",
    securityScan: "Security Scan",
    detailedReport: "Detailed Report",
    cameraNetwork: "Camera Network",
    faceRecognitionAI: "Face Recognition AI",
    motionDetectionSystem: "Motion Detection System",
    accessControlSystem: "Access Control System",
    alarmSystem: "Alarm System",
    emergencyProtocol: "Emergency Protocol",
    networkSecurity: "Network Security",
    dataBackup: "Data Backup",
    cameraTechnicalSpecifications: "Camera Technical Specifications",
    resolutionFPS: "Resolution & FPS",
    zoomCapability: "Zoom Capability",
  ...
  // Navbar search/notifications
  searchPlaceholder: "Search features, pages, or actions...",
  ...
  transactionHistoryDesc: "Latest transactions and payments",
  allTypes: "All Types",
  monthlyFee: "Monthly Fee",
  securityDeposit: "Security Deposit",
  maintenanceFee: "Maintenance Fee",
  paymentIntegration: "Payment Integration",
  paymentIntegrationDesc: "Status of online payment system integration",
  qrisPayment: "QRIS Payment",
  onlineGateway: "Online Gateway",
  lastSync: "Last Sync",
  quickResponseIndonesiaStandard: "Quick Response Indonesia Standard",
  automaticBankIntegration: "Automatic bank integration",
  popularEwallets: "GoPay, OVO, DANA, ShopeePay",
  midtransXenditPaypal: "Midtrans, Xendit, PayPal",
  paymentMethodLabel: "Payment Method",
  autoUpdateFeature: "Auto-Update Feature",
  autoUpdateDesc: "The system will automatically update payment status when transactions succeed via the integrated payment gateway.",

  // Finance (form)
  addManualTransaction: "Add Manual Transaction",
  manualPaymentInputDesc: "Manual payment input (cash transfer, offline payment)",
  blockUnit: "Block/Unit",
  nominal: "Amount",
  paymentType: "Payment Type",
  other: "Other",
  notesOptional: "Notes (Optional)",
  addNotePlaceholder: "Add a note if needed...",
  saveTransaction: "Save Transaction",
  resetForm: "Reset Form",
  blockUnitPlaceholder: "e.g., A-12",

  // OSP/Security shared extra
  camerasOnline: "Cameras Online",
  totalRecordingHours: "Total Recording",
  motionDetection: "Motion Detection",

  // Charts
  securityAnalytics24hOverview: "Security Analytics - 24H Overview",
  realtimeDetectionTrends: "Real-time detection and verification trends",
  totalDetections: "Total Detections",
  threatLevelDistribution: "Threat Level Distribution",
  currentThreatClassification: "Current security threat classification",
  totalLabel: "Total",
  ...
  systemMaintenanceDesc: "Optimize database and clear cache",
  twoFactorAuth: "Two-Factor Authentication (2FA)",
  twoFactorDescription: "Add an extra layer of security to your account",
  twoFactorEnabledNotice: "2FA is enabled and protecting your account",
