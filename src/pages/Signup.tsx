    ...
    <div class="min-h-screen relative" style={backgroundStyle}>
      ...
      <div class="relative z-10 min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div class="hidden lg:block flex-1 max-w-xl pr-16">
            ...
            <div class="mb-12">
              <div class="flex items-center space-x-3 mb-2">
                <div class="w-12 h-12 bg-gradient-to-br from-sky-600 to-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-lg">
                  AB
                </div>
            ...
            <p class="text-lg text-white text-opacity-90 mb-8 leading-relaxed">
              Bergabunglah dengan PT. Akusara Barindo Jaya, developer perumahan terpercaya yang telah membangun ribuan hunian berkualitas di seluruh Indonesia. Daftarkan diri Anda untuk mendapatkan akses eksklusif ke portal klien dan informasi proyek terbaru kami.
            </p>
          ...
          <div class="bg-transparent mx-auto bg-opacity-95 backdrop-blur-xs rounded-2xl shadow-2xl p-8 w-full max-w-md">
            {/* Mobile Logo */}
            <div class="lg:hidden mb-6 text-center">
              <div class="flex items-center justify-center space-x-3 mb-4">
                <div class="w-10 h-10 bg-gradient-to-br from-sky-600 to-indigo-600 rounded-lg flex items-center justify-center text-white font-bold">
                  AB
                </div>
            ...
            <form onSubmit={handleSubmit} class="space-y-4">
              ...
              <div>
                <input
                  type="text"
                  id="fullName"
                  class="w-full px-4 py-4 border-0 rounded-xl bg-white bg-opacity-90 focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all duration-300 outline-none text-gray-700 placeholder-gray-500"
              ...
              <div class="flex items-start space-x-3 py-1">
                <input
                  type="checkbox"
                  id="agreeTerms"
                  class="w-4 h-4 mt-1 text-orange-600 bg-white border-gray-300 rounded"
                  checked={agreeTerms()}
                  onChange={(e) => setAgreeTerms(e.target.checked)}
                  required
                />
                <label for="agreeTerms" class="text-sm text-white text-opacity-90 leading-relaxed">
                  Saya menyetujui{' '}
                  <a href="#" class="text-orange-300 hover:text-orange-200 underline">
            ...
            <div class="mt-2 text-center">
              <p class="text-white text-opacity-80">
                ...
                <button 
                  ...
                  class="text-orange-300 hover:text-orange-200 font-semibold underline"
                >
                  Masuk di sini
                </button>
              </p>
