    ...
    <div class="theme-card rounded-2xl p-6 shadow-xl border">
      <div class="mb-4">
        <h3 class="text-lg font-semibold theme-text-primary mb-1 flex items-center gap-2">
          ...
          {t('securityAnalytics24hOverview')}
        </h3>
        <p class="text-sm theme-text-secondary">{t('realtimeDetectionTrends')}</p>
      </div>
      ...
      <div class="flex gap-4 mb-4">
        <div class="flex items-center gap-2">
          ...
          <span class="text-xs theme-text-secondary">{t('totalDetections')}</span>
        </div>
        <div class="flex items-center gap-2">
          <div class="w-3 h-3 bg-emerald-500 rounded-full"></div>
          <span class="text-xs theme-text-secondary">{t('verified')}</span>
        </div>
        <div class="flex items-center gap-2">
          <div class="w-3 h-3 bg-rose-500 rounded-full"></div>
          <span class="text-xs theme-text-secondary">{t('suspicious')}</span>
        </div>
      </div>
    ...
    <div class="theme-card rounded-2xl p-6 shadow-xl border">
      <div class="mb-4">
        <h3 class="text-lg font-semibold theme-text-primary mb-1 flex items-center gap-2">
          ...
          {t('threatLevelDistribution')}
        </h3>
        <p class="text-sm theme-text-secondary">{t('currentThreatClassification')}</p>
      </div>
            ...
            <div class="text-center">
              <div class="text-xl font-bold theme-text-primary">
                {totalThreats()}
                  ...
                  <div class="text-xs theme-text-tertiary">{t('totalLabel')}</div>
            </div>
          </div>
        </div>
      </div>
